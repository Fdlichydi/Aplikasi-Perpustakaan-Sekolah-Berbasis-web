<div class="col-md-12">
    ...
    <div class="card card-primary">
        ...
        <?php
        echo form_open_multipart('Anggota/Edit/'. $anggota['id_anggota']);
        ?>
        <div class="card-body">
            <div class="row">
                <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="id_kelas" class="form-control" placeholder="Kelas">
                            <option value="<?= $anggota['id_kelas'] ?>"><?= $anggota['id_kelas'] ?></option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label>No Hp</label>
                        <input class="form-control" name="no_hp" value="<?= $anggota['no_hp'] ?>" placeholder="No Hp">
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
