        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('Buku/index1') ?>" class="nav-link <?= $menu == 'buku' ? 'active' : '' ?> ">
                        ...
                        <li class="nav-item <?= $menu == 'transaksi' ? 'menu-open' : '' ?>">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?= base_url('Peminjaman1/index1') ?>" class="nav-link <?= $submenu == 'peminjaman1' ? 'active' : '' ?>">
                                ...
                                <li class="nav-item">
                                    <a href="<?= base_url('Hilang/index1') ?>" class="nav-link <?= $submenu == 'buku hilang' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Buku Hilang</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?= base_url('Denda/index1') ?>" class="nav-link <?= $submenu == 'denda' ? 'active' : '' ?>">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Denda</p>
                                    </a>
                                </li>
